...
activities = {
    ...
    "Soccer Team": {
        "description": "Team training and competitive matches on the school field",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 22,
        "participants": ["nina@mergington.edu", "alex@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim practice and technique improvement for all levels",
    ...
    "Debate Team": {
        "description": "Practice public speaking, research, and argumentative debate skills",
